...
Per-layer, following the split named as an open item in [`overview.md#open-questions--todo`](../../architecture/backend/overview.md#open-questions--todo) — this spec is the first to actually write that strategy down in practice:
